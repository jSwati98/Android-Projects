...
public class Data {
    ...
    public static String[] DEMO_AXES_LABELS = { "Tasks", "Points" };
    public static String DEMO_CHART_TITLE = "Total Points Earned 286.5";
    ...
    public static String[] DEMO_TITLES = { "Maths Homework", "Spelling", "Tennis", "Piano" };
