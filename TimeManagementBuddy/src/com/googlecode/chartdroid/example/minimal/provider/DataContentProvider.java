...
public class DataContentProvider extends ContentProvider {
        ...
        public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
                ...
                if (ColumnSchema.Aspect.DATASET_ASPECT_AXES.equals( uri.getQueryParameter(ColumnSchema.DATASET_ASPECT_PARAMETER) )) {
                        ...
                        int row_index = 0;
                        for (int i=0; i<Data.DEMO_AXES_LABELS.length; i++) {

                                c.newRow().add( row_index ).add( Data.DEMO_AXES_LABELS[i] );
                                row_index++;
                        }
                        ...
                        int row_index = 0;
                        for (int i=0; i<Data.DEMO_TITLES.length; i++) {

                                c.newRow().add( row_index ).add( Data.DEMO_TITLES[i] );
                                row_index++;
                        }
                        ...
                        // Add x-axis data
                        for (int i=0; i<Data.DEMO_X_AXIS_DATA.length; i++) {
                        ...
                        // Add y-axis data
                        for (int i=0; i<Data.DEMO_SERIES_LIST.length; i++) {
                                for (int j=0; j<Data.DEMO_SERIES_LIST[i].length; j++) {
