...
public class RemindersDbAdapter {
     ...
     */
    public long createReminder(String title, String body, String reminderDateTime, String priority) {
    ...
    public Cursor fetchAllReminders() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_TITLE,
                KEY_BODY, KEY_DATE_TIME, KEY_PRIORITY}, null, null, null, null, null);
    }
    ...
    public Cursor fetchReminder(long rowId) throws SQLException {
        ...
        Cursor mCursor =
                ...
                mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                        KEY_TITLE, KEY_BODY, KEY_DATE_TIME, KEY_PRIORITY}, KEY_ROWID + "=" + rowId, null,
                        null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
     ...
     */
    public boolean updateReminder(long rowId, String title, String body, String reminderDateTime, String priority) {
