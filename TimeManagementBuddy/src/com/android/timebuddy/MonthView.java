...
public class MonthView extends TableLayout{
	...
	public static String setDate ="2014-12-11";
	...
	private void init(Context contxt)
	{
		...
		System.out.println("selectedMonth--- 1"+selectedMonth);
	...
	private OnClickListener ChangeMonthListener = new OnClickListener(){
		...
		public void onClick(View v) {
			...
			if(tv.getTag().equals("<"))
			{
				...
				System.out.println("selectedMonth--- 11"+selectedMonth);
				animFlag = false;
			}
	...
	private OnClickListener dayClickedListener = new OnClickListener(){
		@Override
		public void onClick(View v) {
			System.out.println("selected_day 2--->"+tv.getText()+" "+selectedMonth+" "+selectedYear);
			if(tv!=null)
			{
				...
				try{
					if(isEvent[day])
					{
						...
						System.out.println("Date is 1------"+tv.getText().toString().trim());
						setDate = "2013"+"11"+tv.getText().toString().trim();
						System.out.println("setDate--->"+setDate);
						Intent myIntent = new Intent (getContext(), ReminderEditActivity.class);
					...
					System.out.println("in here!!!!!!!!!!!");
						...
						System.out.println("Date is 2------"+tv.getText().toString().trim());
						Intent myIntent = new Intent (getContext(), ReminderEditActivity.class);
						getContext().startActivity(myIntent);
					}
			...
			selected_day = day;
			//System.out.println("selected_day 2--->"+selected_day+" "+month+" "+year);
			tv = (TextView)v;
			tv.setBackgroundResource(R.drawable.selectedgrad);
			DisplayMonth(false);
